        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-8">
              ...
              <p className="lead mb-0">Manage your Eagle Store</p>
            </div>
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-4 col-md-6">
            ...
            >
              <div className="card-body text-center p-5">
                <div className="mb-4">
                  <i className="fas fa-plus-circle text-success fa-5x"></i>
                </div>
                <h3 className="card-title fw-bold text-success mb-3">Add New Product</h3>
          ...
          <div className="col-lg-4 col-md-6">
            ...
            >
              <div className="card-body text-center p-5">
                <div className="mb-4">
                  <i className="fas fa-boxes text-primary fa-5x"></i>
                </div>
                <h3 className="card-title fw-bold text-primary mb-3">Manage Products</h3>
                <p className="card-text text-muted">
          ...
          <div className="col-lg-4 col-md-6">
            ...
            >
              <div className="card-body text-center p-5">
                <div className="mb-4">
                  <i className="fas fa-clipboard-list text-warning fa-5x"></i>
                </div>
                <h3 className="card-title fw-bold text-warning mb-3">Orders Management</h3>
                <p className="card-text text-muted">
          ...
          <div className="col-lg-6 col-md-6">
            <div className="card h-100 shadow-sm">
              <div className="card-body p-4">
                <h4 className="card-title fw-bold text-info mb-4">
                ...
                <div className="row g-3">
                  <div className="col-6">
                    <div className="text-center p-3 bg-light rounded">
                      <i className="fas fa-box text-primary fa-2x mb-2"></i>
                  ...
                  <div className="col-6">
                    <div className="text-center p-3 bg-light rounded">
                      <i className="fas fa-shopping-bag text-success fa-2x mb-2"></i>
                      <h4 className="fw-bold text-success">{stats.totalOrders}</h4>
                  ...
                  <div className="col-6">
                    <div className="text-center p-3 bg-light rounded">
                      <i className="fas fa-dollar-sign text-info fa-2x mb-2"></i>
                      <h4 className="fw-bold text-info">{stats.totalRevenue.toLocaleString()} LE</h4>
          ...
          <div className="col-12">
            <div className="card bg-gradient text-white">
              <div className="card-body text-center py-5">
                <h2 className="fw-bold mb-3">Welcome to Eagle Store Admin Panel</h2>
